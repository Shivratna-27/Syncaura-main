...
const Projects = () => {
  ...
  const tabData = [
    ...
    {
      title: "Ongoing",
      count: PROJECTS.filter((item) => item.priority === "Ongoing").length,
    },
    {
      title: "Completed",
      count: PROJECTS.filter((item) => item.priority === "Completed").length,
    },
    {
      title: "On Hold",
      count: PROJECTS.filter((item) => item.priority === "On Hold").length,
    },
  ];
